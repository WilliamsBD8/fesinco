                    ...
                    <form class="login-form" action="<?= base_url(['validation']) ?>" method="POST">
                        <div class="row">
                            <div class="input-field col s12">
                                <h5 class="ml-4 center-align">Portal FESINCO</h5>
                                <div class="center-align">
                                    <span class="center-align">- Zona segura -</span>
                                </div>
                            </div>
                        </div>
                        <div class="row margin">
                            ...
                            <div class="input-field col s12">
                                ...
                                <input id="capctha" type="text" name="capctha">
                                <label for="capctha">¿Cuánto es <?= 
                                    session('captcha')->number_a
                                    ." ".
                                        (session('captcha')->operacion == 'mas' ? "+" : "-")
                                    ." ".
