                    ...
                    <form class="login-form" method="POST" action="<?= base_url(['forgot_password']) ?>">
                        <div class="row">
                            <div class="input-field col s12">
                                <h5 class="ml-4 center-align">Recuperar Contraseña</h5>
                                <p class="ml-4">Para restablecer la contraseña, por favor ingrese el correo electrónico registrado.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <button  class="btn waves-effect waves-light border-round bg-primary-secondary col s12 mb-1">Recuperar
                                    Contraseña</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s6 m6 l6">
                                <p class="margin medium-small"><a href="<?= base_url(['login']) ?>">Iniciar Sesión</a></p>
                            </div>
